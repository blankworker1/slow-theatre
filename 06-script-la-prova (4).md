...
This version has been written to be performed in Bosa, a rural
community in Sardinia. Its acts and structure are the shared
protocol, common to every Node; its specific words — the toast, the
example promise — are Bosa's own, and are exactly what a new Node
...
without money — it depicts life without the two things people
...
not a spectator merely watching, but someone in a waiting that's
...
> *Marco offers Giulia: three hours helping harvest olives, by the
> next prova.*
> *Chiara offre a Davide: l'uso del suo trapano, da restituire entro
> la prossima prova.*
> *(Chiara offers Davide: use of her drill, to be returned by the
> next prova.)*

*Three examples, deliberately different in kind: a thing given, a
thing done, and a thing lent and owed back. Nothing more is needed.
Whoever looks sees the shape to copy straight away — who, what, by
when, — with no one having to explain it aloud.*
...
happens to be standing there. A future delivery, a future act,
